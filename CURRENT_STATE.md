...
- AI assistance: manual per-lead AI-nettsidesjekk fetches a known homepage and asks OpenAI GPT-5.5 for a short Norwegian website verdict. Manual salgsvinkler use GPT-5.5 web search for one selected lead to summarize public evidence and possible digital offers. Both require LEAD_MACHINE_OPENAI_API_KEY; neither runs in bulk, writes outreach scripts, or takes over seller judgment.
