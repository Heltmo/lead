...
function toLeadSummary(result) {
  return { name: result.name, url: result.url, title: result.title, leadScore: result.leadScore, technologies: result.technologies, issueCategories: result.issueCategories, issueSeverities: result.issueSeverities, performance: result.performance, issues: result.issues, opportunityBullets: result.opportunityBullets }
}
