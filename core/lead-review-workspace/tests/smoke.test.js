...
assert(html.includes('Primary opportunity'), 'workspace should show compressed primary opportunity section')
...
assert(html.includes('Outreach angle:'), 'workspace should show compressed outreach angle')
assert(html.includes('Call opener:'), 'workspace should show compressed call opener')
assert(html.includes('Recommended offer:'), 'workspace should show commercial recommended offer')
assert(html.includes('Class:'), 'workspace should show lead class')
assert(html.includes('Call priority'), 'workspace should show call priority badge')
assert(html.includes('Pain:'), 'workspace should show pain level')
assert(html.includes('Buying:'), 'workspace should show buying likelihood')
assert(html.includes('Sales ease:'), 'workspace should show sales ease')
assert(html.includes('Motion:'), 'workspace should show outreach motion')
...
assert(selectedAfter.includes('Local SEO and page-structure refresh'), 'selected export should include suggested offer')
assert(selectedAfter.includes('This lead matters because'), 'selected export should include why-this-lead-matters sentence')
assert(selectedAfter.includes('leadSummary'), 'selected export should include lead insight header')
assert(selectedAfter.includes('Discovered Example Clinic'), 'selected export should include lead insight content')
...
assert(crmAfter.includes('businessSignals'), 'CRM export should include business signal header')
assert(crmAfter.includes('primaryOpportunity'), 'CRM export should include compressed opportunity header')
assert(crmAfter.includes('leadClass'), 'CRM export should include lead class header')
assert(crmAfter.includes('commercialRecommendedOffer'), 'CRM export should include commercial recommended offer header')
assert(crmAfter.includes('outreachMotion'), 'CRM export should include outreach motion header')
assert(crmAfter.includes('painScore'), 'CRM export should include pain score header')
assert(crmAfter.includes('buyingLikelihood'), 'CRM export should include buying likelihood header')
assert(crmAfter.includes('callPriority'), 'CRM export should include call priority header')
assert(crmAfter.includes('salesEase'), 'CRM export should include sales ease header')
assert(crmAfter.includes('leadSummary'), 'CRM export should include lead insight header')
assert(crmAfter.includes('callOpeningLine'), 'CRM export should include call opener header')
assert(crmAfter.includes('Local SEO and page-structure refresh'), 'CRM export should include suggested offer')
...
assert(htmlAfter.includes('Primary opportunity'), 'workspace should display compressed primary opportunity')
assert(htmlAfter.includes('Call opener:'), 'workspace should display compressed call opener')
assert(htmlAfter.includes('Recommended offer:'), 'workspace should display commercial recommended offer')
assert(htmlAfter.includes('Class:'), 'workspace should display lead class')
assert(htmlAfter.includes('Motion:'), 'workspace should display outreach motion')
assert(htmlAfter.includes('Call priority'), 'workspace should display call priority')
assert(htmlAfter.includes('Pain:'), 'workspace should display pain level')
assert(htmlAfter.includes('Buying:'), 'workspace should display buying likelihood')
assert(htmlAfter.includes('Business signals:'), 'workspace should display structured business signals')
assert(htmlAfter.includes('Outreach angle:'), 'workspace should display compressed outreach angle')
