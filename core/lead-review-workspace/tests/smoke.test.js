...
assert(html.includes('Lead insight'), 'workspace should show lead insight section')
...
assert(html.includes('Recommended offer:'), 'workspace should show insight recommended offer')
assert(html.includes('Call opener:'), 'workspace should show insight call opener')
...
assert(htmlAfter.includes('Why interesting:'), 'workspace should display lead insight why-interesting label')
assert(htmlAfter.includes('Call opener:'), 'workspace should display lead insight call opener')
