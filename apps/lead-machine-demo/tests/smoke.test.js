...
async function main() {
  ...
  assert(lower.includes('data-run-website-audit') && lower.includes('/api/website-audit'), 'Selected lead should offer the website check')
  assert(lower.includes('kjør nettsidesjekk'), 'Website check should use Norwegian copy')
