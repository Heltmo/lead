...
async function main() {
  ...
  assert(lower.includes('risk and caution'), 'UI should expose risk and caution card')
  assert(lower.includes('seller next step'), 'UI should expose seller next step card')
