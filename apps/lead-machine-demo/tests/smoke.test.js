...
async function main() {
  ...
  assert(lower.includes('data-seller-territory') && lower.includes('data-good-customer') && lower.includes('data-disqualifiers'), 'saved searches should carry seller setup data')
