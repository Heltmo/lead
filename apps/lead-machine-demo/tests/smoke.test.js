...
async function main() {
  ...
  assert(lower.includes('seller-setup-panel') && lower.includes('sellersetupsummary'), 'UI should expose a compact seller setup panel')
  assert(lower.includes('seller-setup-collapse'), 'Seller setup should stay collapsed behind a summary toggle so search stays primary')
  assert(lower.includes('sellerterritory') && lower.includes('idealcustomer') && lower.includes('disqualifiers'), 'UI should collect seller geography, good-customer hints and disqualifiers')
  assert(lower.includes('leadmachinesellersetup') && lower.includes('sellerprofile'), 'UI should persist and submit seller profile setup')
  ...
  assert(lower.includes('setupversion'), 'Stored seller setup should migrate once to the website-sales default')
