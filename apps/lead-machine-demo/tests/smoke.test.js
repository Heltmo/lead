...
async function main() {
  ...
  assert(lower.includes('kun valgt sted') && lower.includes('nærområde') && lower.includes('regionalt'), 'UI should use human-readable geography scope labels')
  ...
  assert(lower.includes('call status'), 'UI should expose general call status')
  assert(lower.includes('website opportunity'), 'UI should separate website opportunity from generic call status')
  ...
  assert(lower.includes('current-call'), 'UI should summarize one current call')
  ...
  assert(lower.includes('finn lokale bedrifter raskt'), 'Search hint should be seller-readable and compact')
  ...
  assert(lower.includes('current-call-board'), 'UI should render one current call instead of a dense queue board')
  assert(lower.includes('next call'), 'Workflow board should show the next call lead')
