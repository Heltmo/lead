...
async function main() {
  ...
  assert(lower.includes('enrich lead for a focused retry'), 'UI should frame Brreg gaps as selected-lead retry work')
  ...
  assert(lower.includes('lead workflow'), 'UI should include the lead workflow panel')
  ...
  assert(lower.includes('called / done'), 'UI should include a clear Called / done quick action')
  ...
  assert(lower.includes('call again'), 'No-answer workflow should still set the next action for follow-up')
  ...
  assert(lower.includes('outcome and next action'), 'Selected lead should show a compact outcome and next-action panel')
  assert(lower.includes('short call note'), 'Lead workflow should keep the note prompt short')
