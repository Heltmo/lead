...
async function main() {
  ...
  assert(response.body.leadPacks[0].sellerFit.fitReasons.includes('matches seller geography: kristiansand'), 'seller territory should affect lead fit reasons')
  assert(response.body.leadPacks[0].sellerFit.fitReasons.includes('matches good-customer hint: local'), 'good-customer setup should affect lead fit reasons')
  ...
  assert(lower.includes('phone-ready'), 'Command center should show phone-ready counts')
