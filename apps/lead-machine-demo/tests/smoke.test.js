...
async function main() {
  ...
  assert(lower.includes('neste: ring') && lower.includes('ring først') && lower.includes('verifiser først') && lower.includes('marked og varselsignaler'), 'UI should expose a simple next-move Command Center')
